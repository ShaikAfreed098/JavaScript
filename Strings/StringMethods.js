...
let s1 = "LoveYourSelf";
let slicedStr = s1.slice(0, 5);
console.log(slicedStr); // Output: LoveY

//substring() method returns the part of the string between the start and end indexes, or to the end of the string.
let s2 = "LoveYourSelf";
let subStr1 = s2.substring(0, 5);
console.log(subStr1); // Output: LoveY

//substr() method returns the part of the string starting at the specified index and extending for a given number of characters afterwards.
let s3 = "LoveYourSelf";
let subStr2 = s3.substr(0, 9);
console.log(subStr2); // Output: LoveYourSelf
...
console.log(part); // Output: Mind, Space, Soul
